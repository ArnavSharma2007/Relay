...
export type SessionStatus = 'waiting' | 'connecting' | 'live' | 'reconnecting' | 'ended' | 'failed';
...
export type TimelineEventType = 'join' | 'leave' | 'recording_start' | 'recording_stop' | 'file_upload' | 'network_drop' | 'reconnect' | 'error' | 'end' | 'system';
